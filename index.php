...
#nav-container .nav-item.has-submenu > .nav-link {
    position: relative;
    padding-right: 30px !important;
}

#nav-container .nav-item.has-submenu > .nav-link::after {
    content: '';
    position: absolute;
    right: 10px;
    top: 50%;
...
#nav-container .nav-item.has-submenu > .nav-link.active::after {
...
/* Убедитесь, что у подпунктов стрелка скрыта */
        ...
        <div class="container">
            <div class="d-flex align-items-end">
                ...
                <h2 id="page-title-header" class="mb-0">
                    ...
                    } elseif (isset($_GET['page']) && $_GET['page'] === 'hard') {
                        $pageTitle = "Типовые формы CRUD сложных сущностей";
                    } elseif (isset($_GET['page']) && $_GET['page'] === 'hard-view') {
                        $pageTitle = "Типовые формы CRUD сложных сущностей - просмотр";
                    }
                    echo $pageTitle;
                    ?>
                </h2>

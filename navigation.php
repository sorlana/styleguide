<nav class="nav flex-column">
    ...
    <div class="nav-item has-submenu">
        <a class="nav-link <?php echo (isset($_GET['page']) && $_GET['page'] === 'hard') ? 'active' : ''; ?>" href="?page=hard">
            Типовые формы CRUD сложных сущностей
        </a>
        <?php if (isset($_GET['page']) && $_GET['page'] === 'hard'): ?>
            <a class="nav-link nav-link-2 <?php echo (isset($_GET['anchor']) && $_GET['anchor'] === 'section1') ? 'active' : ''; ?>" href="?page=hard&anchor=section1">Создание</a>
            <a class="nav-link nav-link-2 <?php echo (isset($_GET['anchor']) && $_GET['anchor'] === 'section2') ? 'active' : ''; ?>" href="?page=hard&anchor=section2">Редактирование</a>
            <a class="nav-link nav-link-2 <?php echo (isset($_GET['anchor']) && $_GET['anchor'] === 'section3') ? 'active' : ''; ?>" href="?page=hard&anchor=section3">Удаление</a>
        <?php endif; ?>
    </div>

    <div class="nav-item">
        <a class="nav-link <?php echo (isset($_GET['page']) && $_GET['page'] === 'hard-view') ? 'active' : ''; ?>" href="?page=hard-view">
            Типовые формы CRUD сложных сущностей - просмотр
        </a>
        <?php if (isset($_GET['page']) && $_GET['page'] === 'hard-view'): ?>
        <?php endif; ?>
    </div>
